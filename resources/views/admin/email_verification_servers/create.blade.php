...
@section('content')
	...
	<form action="{{ action('Admin\EmailVerificationServerController@store', ["type" => request()->type]) }}" method="POST" class="form-validate-jqueryz email-verification-server-form custom-box">
		{{ csrf_field() }}
