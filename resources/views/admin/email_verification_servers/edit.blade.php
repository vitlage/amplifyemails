...
@section('content')
    ...
    <form enctype="multipart/form-data" action="{{ action('Admin\EmailVerificationServerController@update', $server->uid) }}" method="POST" class="form-validate-jqueryz email-verification-server-form custom-box">
        {{ csrf_field() }}
