...
@section('content')
				...
				<form enctype="multipart/form-data" action="{{ action('Admin\FeedbackLoopHandlerController@update', $server->uid) }}" method="POST" class="form-validate-jquery custom-box">
					{{ csrf_field() }}
