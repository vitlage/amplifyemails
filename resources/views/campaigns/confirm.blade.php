...
@section('content')
    ...
    <div class="confirm-campaign-box">
        <form action="{{ action('CampaignController@confirm', $campaign->uid) }}" method="POST" class="form-validate-jqueryz custom-box1">
            {{ csrf_field() }}
...
visibility
                ...
                @else
                    ...
                    <div class="text-end">
                        ...
                        >
                            {{ trans('messages.campaign.preview_as') }} <span class="material-icons-outlined ms-1">
                                contact_mail
</span>
                        </button>
                        <span
