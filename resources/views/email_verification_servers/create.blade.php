...
@section('content')
	...
	<form action="{{ action('EmailVerificationServerController@store', ["type" => request()->type]) }}" method="POST" class="form-validate-jqueryz email-verification-server-form custom-box1">
		{{ csrf_field() }}
