...
@section('content')
    ...
    <form enctype="multipart/form-data" action="{{ action('EmailVerificationServerController@update', $server->uid) }}" method="POST" class="form-validate-jqueryz email-verification-server-form custom-box1">
        {{ csrf_field() }}
